...
user1 = UserInfo(userid=user1.id,username=user1.email,email=user1.username)
user1.save()
user2 = UserInfo(userid=user2.id,username=user2.email,email=user2.username)
user2.save()
